...
(function(e) {
    ...
    function barChart(options) {
        ...
        function createStacked() {
            ...
            columnRects
                .attr('x', 0)
                .attr('y', function (d) { return axis.yScale(d.data[xField]); })
                .attr('width', 0)
                .attr('height', axis.yScale.bandwidth());
        ...
        function createGrouped() {
            //create group axis
            groupAxis = d3.scaleBand().domain(chart.serieNames).range([0, axis.yScale.bandwidth()]).round(true).padding(0.1);
            ...
            columnSeries = chartG.selectAll('.eve-bar-serie')
                ...
                .attr('transform', function(d) {
                    return 'translate(0, ' + axis.yScale(d[chart.xField]) + ')';
                });
            ...
            columnRects = columnSeries.selectAll('rect')
                ...
                .attr('width', 0)
                .attr('height', singleGroupWidth)
                .attr('x', axis.xScale(0))
                .attr('y', function(d) { return groupAxis(d.name); })
                .on('click', function (d) {
                    if(chart.sliceClick)
                        chart.sliceClick(d.data);
                })
    ...
    //attach bar chart method into the eve
